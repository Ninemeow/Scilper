                            ...
                            <div class="com-footer">
                                <div>
                                    ...
                                    <?php if (akina_option('open_private_message') != '0') { ?>
                                        <label class="siren-checkbox-label"><input class="siren-checkbox-radio" type="checkbox" name="is-private"><span class="siren-is-private-checkbox siren-checkbox-radioInput"></span>私密评论 | Comment in private</label>
                                    <?php } ?>
                                </div>
