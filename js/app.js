			...
			if ($('div').hasClass('post_nav')) {
				...
				$(window).scroll(function () {
					if ($(this).scrollTop() > offset.top) {
						...
						$mulu.addClass('moving').css({'left': mulu_left + 184 - mulu_w + 'px'});
					} else {
...
$(function() {
    ...
    console.log("%c Github %c","background:#9a9da2; color:#ffffff; border-radius:4px;","","https://github.com/Ninemeow");
...
function add_copyright() {
    ...
    function setClipboardText(event) {
        event.preventDefault();
        var htmlData = "" + "著作权归原作者所有。<br>" + "商业转载请联系作者获得授权，非商业转载请注明出处。<br>" + "作者：" + scilper_option.author_name + "<br>" + "链接：" + window.location.href + "<br>" + "来源：" + scilper_option.site_name + "<br><br>" + window.getSelection().toString().replace(/\r\n/g, "<br>");;
        var textData = "" + "著作权归原作者所有。\n" + "商业转载请联系作者获得授权，非商业转载请注明出处。\n" + "" + scilper_option.author_name + "\n" + "链接：" + window.location.href + "\n" + "来源：" + scilper_option.site_name + "\n\n" + window.getSelection().toString().replace(/\r\n/g, "\n");
