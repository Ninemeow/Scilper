...
?>
	<article class="post post-list-thumb <?php echo $class; ?>" itemscope="" itemtype="contentUrl">
		...
		<div class="post-content-wrap">
			<div class="post-content">
				...
				<div class="post-meta">
					...
					<span><i class="iconfont">&#xe739;</i><a href="<?php echo esc_url(get_category_link($the_cat[0]->cat_ID)); ?>"><?php echo $the_cat[0]->cat_name; ?></a></span>
				</div>
